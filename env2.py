...
pixels = 20   # pixels
env2_height = 25  # grid height
env2_width = 25  # grid width
...
class Environment(tk.Tk, object):
    def __init__(self):
        ...
        self.geometry('{0}x{1}'.format(env2_height * pixels, env2_height * pixels))
    ...
    def build_Environment(self):
        ...
        for column in range(0, env2_width * pixels, pixels):
            x0, y0, x1, y1 = column, 0, column, env2_height * pixels
            self.canvas_widget.create_line(x0, y0, x1, y1, fill='grey')
        for row in range(0, env2_height * pixels, pixels):
            x0, y0, x1, y1 = 0, row, env2_height * pixels, row
            self.canvas_widget.create_line(x0, y0, x1, y1, fill='grey')
        ...
        obstacle51_center = self.o + np.array([pixels * 6, pixels * 3])
        ...
        # In order to fit the coordinates of the agent
        self.coords_obstacle51 = [self.canvas_widget.coords(self.obstacle49)[0] + 3,
                                  self.canvas_widget.coords(self.obstacle49)[1] + 3,
                                  self.canvas_widget.coords(self.obstacle49)[2] - 3,
                                  self.canvas_widget.coords(self.obstacle49)[3] - 3]
        ...
        obstacle52_center = self.o + np.array([pixels * 7, pixels * 3])
        ...
        # In order to fit the coordinates of the agent
        self.coords_obstacle52 = [self.canvas_widget.coords(self.obstacle49)[0] + 3,
                                  self.canvas_widget.coords(self.obstacle49)[1] + 3,
                                  self.canvas_widget.coords(self.obstacle49)[2] - 3,
                                  self.canvas_widget.coords(self.obstacle49)[3] - 3]
        # Obstacle 53
        # Defining the center of obstacle 53
        obstacle53_center = self.o + np.array([pixels * 8, pixels * 3])
        ...
        obstacle54_center = self.o + np.array([pixels * 9, pixels * 3])
        ...
        obstacle55_center = self.o + np.array([pixels * 10, pixels * 3])
        ...
        obstacle56_center = self.o + np.array([pixels * 11, pixels * 3])
        ...
        obstacle57_center = self.o + np.array([pixels * 12, pixels * 3])
        ...
        obstacle58_center = self.o + np.array([pixels * 6, pixels * 4])
        ...
        obstacle59_center = self.o + np.array([pixels * 6, pixels * 5])
        ...
        # Obstacle 59
        # Defining the center of obstacle 59
        obstacle60_center = self.o + np.array([pixels * 6, pixels * 6])
        ...
        obstacle61_center = self.o + np.array([pixels * 7, pixels * 8])
        ...
        obstacle62_center = self.o + np.array([pixels * 8, pixels * 8])
        ...
        obstacle63_center = self.o + np.array([pixels * 9, pixels * 8])
        ...
        obstacle64_center = self.o + np.array([pixels * 9, pixels * 9])
        ...
        obstacle65_center = self.o + np.array([pixels * 9, pixels * 14])
        ...
        obstacle66_center = self.o + np.array([pixels * 9, pixels * 13])
        ...
        obstacle67_center = self.o + np.array([pixels * 9, pixels * 12])
        ...
        obstacle68_center = self.o + np.array([pixels * 9, pixels * 11])
        ...
        obstacle69_center = self.o + np.array([pixels * 9, pixels * 10])
        ...
        obstacle70_center = self.o + np.array([pixels * 13, pixels * 10])
        ...
        obstacle71_center = self.o + np.array([pixels * 14, pixels * 10])
        ...
        obstacle72_center = self.o + np.array([pixels * 15, pixels * 10])
        ...
        obstacle73_center = self.o + np.array([pixels * 16, pixels * 10])
        ...
        obstacle74_center = self.o + np.array([pixels * 13, pixels * 11])
        ...
        obstacle75_center = self.o + np.array([pixels * 13, pixels * 12])
        ...
        obstacle76_center = self.o + np.array([pixels * 1, pixels * 23])
        ...
        obstacle77_center = self.o + np.array([pixels * 2, pixels * 23])
        ...
        obstacle78_center = self.o + np.array([pixels * 3, pixels * 23])
        ...
        obstacle79_center = self.o + np.array([pixels * 4, pixels * 23])
        ...
        obstacle80_center = self.o + np.array([pixels * 5, pixels * 23])
        ...
        obstacle81_center = self.o + np.array([pixels * 6, pixels * 23])
        ...
        obstacle82_center = self.o + np.array([pixels * 7, pixels * 23])
        ...
        # Obstacle 82
        # Defining the center of obstacle 82
        obstacle82_center = self.o + np.array([pixels * 7, pixels * 22])
        # Building the obstacle 82
        self.obstacle82 = self.canvas_widget.create_rectangle(
            obstacle82_center[0] - 10, obstacle82_center[1] - 10,  # Top left corner
            obstacle82_center[0] + 10, obstacle82_center[1] + 10,  # Bottom right corner
        ...
        obstacle83_center = self.o + np.array([pixels * 7, pixels * 21])
        ...
        obstacle84_center = self.o + np.array([pixels * 7, pixels * 20])
        ...
        obstacle85_center = self.o + np.array([pixels * 7, pixels * 19])
        ...
        obstacle86_center = self.o + np.array([pixels * 7, pixels * 18])
        ...
        obstacle87_center = self.o + np.array([pixels * 7, pixels * 17])
        ...
        obstacle88_center = self.o + np.array([pixels * 9, pixels * 17])
        ...
        obstacle89_center = self.o + np.array([pixels * 10, pixels * 17])
        ...
        obstacle90_center = self.o + np.array([pixels * 11, pixels * 17])
        ...
        obstacle91_center = self.o + np.array([pixels * 9, pixels * 18])
        ...
        obstacle92_center = self.o + np.array([pixels * 9, pixels * 19])
        ...
        obstacle93_center = self.o + np.array([pixels * 10, pixels * 19])
        ...
        obstacle94_center = self.o + np.array([pixels * 11, pixels * 19])
        ...
        obstacle95_center = self.o + np.array([pixels * 12, pixels * 19])
        ...
        obstacle96_center = self.o + np.array([pixels * 13, pixels * 19])
        ...
        obstacle97_center = self.o + np.array([pixels * 13, pixels * 20])
        ...
        obstacle98_center = self.o + np.array([pixels * 16, pixels * 24])
        ...
        obstacle99_center = self.o + np.array([pixels * 15, pixels * 24])
        ...
        obstacle100_center = self.o + np.array([pixels * 15, pixels * 23])
        ...
        obstacle101_center = self.o + np.array([pixels * 15, pixels * 22])
        ...
        obstacle102_center = self.o + np.array([pixels * 15, pixels * 21])
        ...
        obstacle103_center = self.o + np.array([pixels * 15, pixels * 20])
        ...
        obstacle104_center = self.o + np.array([pixels * 15, pixels * 19])
        ...
        obstacle105_center = self.o + np.array([pixels * 15, pixels * 18])
        ...
        obstacle106_center = self.o + np.array([pixels * 15, pixels * 17])
        ...
        obstacle107_center = self.o + np.array([pixels * 15, pixels * 16])
        ...
        obstacle108_center = self.o + np.array([pixels * 16, pixels * 14])
        ...
        obstacle109_center = self.o + np.array([pixels * 17, pixels * 14])
        ...
        obstacle110_center = self.o + np.array([pixels * 18, pixels * 14])
        ...
        obstacle111_center = self.o + np.array([pixels * 18, pixels * 15])
        ...
        obstacle112_center = self.o + np.array([pixels * 18, pixels * 16])
        ...
        obstacle113_center = self.o + np.array([pixels * 19, pixels * 12])
        ...
        obstacle114_center = self.o + np.array([pixels * 20, pixels * 12])
        ...
        obstacle115_center = self.o + np.array([pixels * 21, pixels * 12])
        ...
        obstacle116_center = self.o + np.array([pixels * 22, pixels * 12])
        ...
        obstacle117_center = self.o + np.array([pixels * 22, pixels * 13])
        ...
        obstacle118_center = self.o + np.array([pixels * 22, pixels * 14])
        ...
        obstacle119_center = self.o + np.array([pixels * 21, pixels * 18])
        ...
        obstacle120_center = self.o + np.array([pixels * 22, pixels * 18])
        ...
        obstacle121_center = self.o + np.array([pixels * 23, pixels * 18])
        ...
        obstacle122_center = self.o + np.array([pixels * 23, pixels * 19])
        ...
        obstacle123_center = self.o + np.array([pixels * 23, pixels * 20])
        ...
        obstacle124_center = self.o + np.array([pixels * 23, pixels * 21])
        ...
        obstacle125_center = self.o + np.array([pixels * 23, pixels * 22])
        ...
        obstacle126_center = self.o + np.array([pixels * 23, pixels * 23])
        ...
        obstacle127_center = self.o + np.array([pixels * 23, pixels * 24])
    ...
    def step(self, action):
        ...
        # Action 'down'
            ...
            if state[1] < (env2_height - 1) * pixels:
                base_action[1] += pixels
        # Action right
        elif action == 2:
            if state[0] < (env2_width - 1) * pixels:
