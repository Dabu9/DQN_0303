...
class Environment(tk.Tk, object):
    ...
    def build_environment(self):
        ...
        self.obstacle_coords = [self.coords_obstacle1,
        ...
        self.obstacles_index = np.zeros(len(self.obstacle_coords))
        ...
        flag_center = self.o + np.array([pixels * 10, pixels * 10])
        # Building the flag
    ...
    def step(self, action):
        ...
        elif next_state in self.obstacle_coords:
            index = self.obstacle_coords.index(next_state)
