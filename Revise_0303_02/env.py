...
class Environment(tk.Tk, object):
    ...
    def reset(self):
        ...
        # Return observation
        return (np.array(self.canvas_widget.coords(self.agent)[:2]) - np.array(self.canvas_widget.coords(self.flag)[:2]))/(env_height * pixels)
    ...
    def step(self, action):
        ...
        next_state = np.array(self.canvas_widget.coords(self.agent)[:2] - np.array(self.canvas_widget.coords(self.flag)[:2])) / (env_height * pixels)
