...
class DeepQNetwork:
    ...
    def _build_net(self):
        self.q_eval = Net(self.n_features, self.n_hidden1, self.n_actions)
        self.q_target = Net(self.n_features, self.n_hidden1, self.n_actions)
    ...
    def choose_action(self, observation):
        ...
        if np.random.uniform() < self.epsilon:
            ...
            if observation.equal(a):
                self.actions_value_cl.append(actions_value[0][1])
            # 选择最大动作价值对应的action
